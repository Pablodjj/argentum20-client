...
Public Sub WriteSilenciarUser(ByVal UserName As String, ByVal Time As Byte)
    ...
    '***************************************************
    With outgoingData
        Call .WriteID(ClientPacketID.SilenciarUser)
...
Public Sub WriteNuevaCuenta()
    ...
    With outgoingData
        Call .WriteID(ClientPacketID.CrearNuevaCuenta)
...
Public Sub WriteValidarCuenta()
    ...
    With outgoingData
        Call .WriteID(ClientPacketID.validarCuenta)
...
Public Sub WriteReValidarCuenta()
    ...
    With outgoingData
        Call .WriteID(ClientPacketID.RevalidarCuenta)
...
Public Sub WriteRecuperandoConstraseña()
    ...
    With outgoingData
        Call .WriteID(ClientPacketID.RecuperandoConstraseña)
...
Public Sub WriteBorrandoCuenta()
    ...
    With outgoingData
        Call .WriteID(ClientPacketID.BorrandoCuenta)
...
Private Sub HandlePersonajesDeCuenta()
    ...
    For i = 1 To CantidadDePersonajesEnCuenta
        ...
        Select Case Pjs(i).Criminal
            ...
            Case 2 'Caos
                Call SetRGBA(Pjs(i).LetraColor, 179, 0, 4)
                Pjs(i).priv = 0

            Case 3 'Armada
                Call SetRGBA(Pjs(i).LetraColor, 31, 139, 139)
                Pjs(i).priv = 0
...
Private Sub HandleUserOnline()
    ...
    Dim rdata As Integer: rdata = buffer.ReadInteger()
